...
for name, model in models.items():
    ...
    with mlflow.start_run(run_name=name) as run:
        ...
        print(f"Accuracy (Test Set): {accuracy:.4f}, Precision: {precision:.4f}, Recall: {recall:.4f}, F1-Score: {f1:.4f}")
        ...
        print(f"Accuratezza Media da CV: {mean_cv_accuracy:.4f} (+/- {std_cv_accuracy:.4f})")
#new
